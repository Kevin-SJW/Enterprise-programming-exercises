...
/**
 * @Classname ListComparasions
 * @Description TODO
 * @Date 2019/11/27 17:32
 * @Created by 14241
 */

import Container.CountingIntegerList;
...
abstract class ListTest extends Tester<List<Integer>> {
    ...
    class Reader extends TestTask {
        ...
        @Override
        void test() {
            for (long i = 0; i < Tester.testCycles; i++) {
                for (int index = 0; index < Tester.containerSize; index++) {
...
class CopyOnWriteArrayListTest extends ListTest {
    ...
    List<Integer> containerInitializer() {
        return new CopyOnWriteArrayList<Integer>(
                new CountingIntegerList(Tester.containerSize));
    }
